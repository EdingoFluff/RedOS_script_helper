...
# --- КОНФИГУРАЦИЯ API ---
API_KEY = "" # Не забудьте вставить ваш ключ
...
- Перед началом выполнения инструкций открывай новое окно терминала и работай там, только если не делал этого ранее
- Пакеты: dnf вместо apt
- Если для выполнения команды необходим доступ администратора, перед вводом команды делай "su -" "enter" "1" "enter"
